...
export default function Home() {
  ...
  const visionMissionTranslations = {
    card1Title: home("VisionMission.Card1.Title"),
    card1Description: home("VisionMission.Card1.Description"),
    card2Title: home("VisionMission.Card2.Title"),
    card2Description: home("VisionMission.Card2.Description"),
  };

  const valuesTranslations = [
    {
      title: home("Values.Value1.title"),
      description: home("Values.Value1.description"),
      svgPath:
    ...
    {
      title: home("Values.Value2.title"),
      description: home("Values.Value2.description"),
      svgPath:
    ...
    {
      title: home("Values.Value3.title"),
      description: home("Values.Value3.description"),
      svgPath:
    ...
    {
      title: home("Values.Value4.title"),
      description: home("Values.Value4.description"),
      svgPath:
    ...
    {
      title: home("Values.Value5.title"),
      description: home("Values.Value5.description"),
      svgPath:

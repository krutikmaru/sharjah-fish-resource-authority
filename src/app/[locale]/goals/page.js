...
import StrategicGoals from "../../../components/Goals/StrategicGoals";
import DevelopmentGoals from "../../../components/Goals/DevelopmentGoals";

const Goals = () => {
  const goals = useTranslations("Goals");
  const strategicGoalsTranslations = {
    title: goals("Strategic.Title"),
    subtitle: goals("Strategic.Subtitle"),
    description: goals("Strategic.Description"),
    goals: [
      {
        title: goals("Strategic.Goal1.Title"),
        description: goals("Strategic.Goal1.Description"),
      ...
      {
        title: goals("Strategic.Goal2.Title"),
        description: goals("Strategic.Goal2.Description"),
      ...
      {
        title: goals("Strategic.Goal3.Title"),
        description: goals("Strategic.Goal3.Description"),
      ...
      {
        title: goals("Strategic.Goal4.Title"),
        description: goals("Strategic.Goal4.Description"),
      },
      {
        title: goals("Strategic.Goal5.Title"),
        description: goals("Strategic.Goal5.Description"),
      ...
      {
        title: goals("Strategic.Goal6.Title"),
        description: goals("Strategic.Goal6.Description"),
      ...
      {
        title: goals("Strategic.Goal7.Title"),
        description: goals("Strategic.Goal7.Description"),
  ...
  const developmentGoalsTranslations = {
    title: goals("Development.Title"),
    subtitle: goals("Development.Subtitle"),
    description: goals("Development.Description"),
    goals: [
      {
        numeric: 3,
        title: goals("Development.Goal3.Description"),
        description: goals("Development.Goal3.Description"),
      },
      {
        numeric: 4,
        title: goals("Development.Goal4.Description"),
        description: goals("Development.Goal4.Description"),
      },
      {
        numeric: 8,
        title: goals("Development.Goal8.Description"),
        description: goals("Development.Goal8.Description"),
      },
      {
        numeric: 9,
        title: goals("Development.Goal9.Description"),
        description: goals("Development.Goal9.Description"),
      },
      {
        numeric: 14,
        title: goals("Development.Goal14.Description"),
        description: goals("Development.Goal14.Description"),
      },
      {
        numeric: 17,
        title: goals("Development.Goal17.Description"),
        description: goals("Development.Goal17.Description"),
      },
    ],
  };
  ...
  return (
    <>
      <StrategicGoals strategicGoalsTranslations={strategicGoalsTranslations} />
      <DevelopmentGoals
        developmentGoalsTranslations={developmentGoalsTranslations}
      />
    </>
  );
};
